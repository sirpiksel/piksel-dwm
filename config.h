...
static const char *fonts[] = {
    "MesloLGS NF:style=Regular:pixelsize=10:antialias=true:autohint=true"};
...
static const Block blocks[] = {
    ...
    {col_sel,
     "pactl get-sink-volume @DEFAULT_SINK@ | awk '{print $5}' | sed -n 1p", 1,
     3},
    {col_sel,
     "awk '{ printf \"%s \", $0 }' /sys/class/net/eth*/operstate | sed 's/ "
     "$//'",
     10, 5},
};
...
static const char *otpcmd[] = {
    "/home/philip/.config/pass-otp-helper/otpmenu.sh", "-c", "-l", "5", NULL};
